<?php
/* Smarty version 3.1.33, created on 2019-07-09 17:58:58
  from '/Users/razib/Documents/valet/ibc/ibilling/apps/theme_options/views/nav.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d250e2289e8a6_17060206',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '38ee8214239c51851a847e00bea209f2a3c19f30' => 
    array (
      0 => '/Users/razib/Documents/valet/ibc/ibilling/apps/theme_options/views/nav.tpl',
      1 => 1562708983,
      2 => 'file',
    ),
  ),
...
function content_5d250e2289e8a6_17060206 (Smarty_Internal_Template $_smarty_tpl) {
?><ul class="acc-menu">
    <?php echo $_smarty_tpl->tpl_vars['admin_extra_nav']->value[0];?>

    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;
echo $_smarty_tpl->tpl_vars['_c']->value['redirect_url'];?>
/"><i class="ti ti-home"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Dashboard'];?>
</span></a></li>
    ...
    <li><a href="javascript:;"><i class="ti ti-user"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Customers'];?>
</span></a>
        <ul class="acc-menu">
            <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/companies/"><i class="ti ti-layout"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Companies'];?>
</span></a></li>
    <?php }?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['_c']->value['accounting'] == '1') {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-server"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Transactions'];?>
</span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
generate/balance-sheet/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Balance Sheet'];?>
    ...
    <?php if (($_smarty_tpl->tpl_vars['_c']->value['invoicing'] == '1') || ($_smarty_tpl->tpl_vars['_c']->value['quotes'] == '1')) {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-shopping-cart"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Sales'];?>
</span></a>
            <ul class="acc-menu">
...
invoices/payments/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Payments'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'orders')) {?>
        ...
        <?php if (($_smarty_tpl->tpl_vars['_c']->value['orders'] == '1')) {?>
            ...
            <li>
                <a href="javascript:;"><i class="ti ti-pencil-alt"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Orders'];?>
</span></a>
                <ul class="acc-menu">
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
orders/add/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Add New Order'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'documents')) {?>
        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
documents/"><i class="ti ti-file"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Documents'];?>
</span></a></li>
    <?php }?>

    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'calendar')) {?>
        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
calendar/events/"><i class="ti ti-agenda"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Calendar'];?>
</span></a></li>
    <?php }?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'bank_n_cash')) {?>
        <li>
            <a href="javascript:;"><i class="ti ti-view-list-alt"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Bank n Cash'];?>
</span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
accounts/balances/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Account_Balances'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'products_n_services')) {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-package"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Products n Services'];?>
</span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
ps/s-new/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['New Service'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'reports')) {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-stats-up"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Reports'];?>
 </span></a>
            <ul class="acc-menu">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'utilities')) {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-view-list"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Utilities'];?>
 </span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
terminal/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Terminal'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'appearance')) {?>
        ...
        <li>
            <a href="javascript:;"><i class="ti ti-layout-sidebar-left"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Appearance'];?>
 </span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
appearance/themes/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Themes'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'plugins')) {?>
        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
settings/plugins/"><i class="ti ti-layout-tab-window"></i><span><?php echo $_smarty_tpl->tpl_vars['_L']->value['Plugins'];?>
</span></a></li>
    <?php }?>

    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'settings')) {?>
        <li>
            <a href="javascript:;"><i class="ti ti-settings"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Settings'];?>
 </span></a>
            <ul class="acc-menu">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
