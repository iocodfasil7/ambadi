...
if($config['build'] <= 4670){
    ...
    if(!db_column_exist('sys_documents','is_global')){
        ORM::execute('ALTER TABLE `sys_documents` ADD `is_global` INT(1) NOT NULL DEFAULT \'0\'');
    }
...
// after 4622
    ...
    if(!hasColumn('all_data','sys_staffpermissions')){
        ORM::execute('ALTER TABLE `sys_staffpermissions` ADD `all_data` INT(1) NOT NULL DEFAULT \'0\' AFTER `can_delete`');
    }
    ...
    if(!hasColumn('is_email_verified','crm_accounts')){
        ORM::execute('ALTER TABLE `crm_accounts` DROP `email_verified`, ADD `is_email_verified` INT(1) NOT NULL DEFAULT \'0\', ADD `is_phone_veirifed` INT(1) NOT NULL DEFAULT \'0\', ADD `photo_id_type` VARCHAR(100) NULL DEFAULT NULL, ADD `photo_id` VARCHAR(100) NULL DEFAULT NULL');
    }

    if(!hasColumn('aid','sys_invoices')){
        ORM::execute('ALTER TABLE `sys_invoices` ADD `aid` INT(11) NOT NULL DEFAULT \'0\', ADD `aname` VARCHAR(200) NULL DEFAULT NULL');
    }
...
// future
    ...
    ORM::execute('ALTER TABLE `sys_currencies` CHANGE `rate` `rate` DECIMAL(16,8) NOT NULL DEFAULT \'1.00000000\'');

    ORM::execute('ALTER TABLE `sys_companies` CHANGE `created_at` `created_at` TIMESTAMP NULL DEFAULT NULL');
    ORM::execute('ALTER TABLE `sys_companies` CHANGE `updated_at` `updated_at` TIMESTAMP NULL DEFAULT NULL');

    if(!hasColumn('username','crm_accounts')){
        ORM::execute('ALTER TABLE `crm_accounts` ADD `username` VARCHAR(100) NULL DEFAULT NULL AFTER `email`');
    }
...
// ALTER TABLE `sys_cats` ADD `amount` DECIMAL(16,4) NULL DEFAULT '0.0000' AFTER `type`;
    ...
    ORM::execute('ALTER TABLE `sys_cats` ADD `total_amount` DECIMAL(16,4) NULL DEFAULT \'0.0000\', ADD `budget` DECIMAL(16,4) NULL DEFAULT \'0.0000\', ADD `created_at` TIMESTAMP NULL, ADD `updated_at` TIMESTAMP NULL');
    ...
    ORM::execute('ALTER TABLE `sys_transactions` ADD `base_amount` DECIMAL(16,4) NOT NULL DEFAULT \'0.0000\' AFTER `currency_rate`, MODIFY updated_at TIMESTAMP NULL, ADD created_at TIMESTAMP NULL AFTER aid, MODIFY category VARCHAR(200) NULL, MODIFY payer VARCHAR(200) NULL, MODIFY payee VARCHAR(200) NULL, MODIFY method VARCHAR(200) NULL, MODIFY ref VARCHAR(200) NULL, MODIFY description TEXT NULL, MODIFY tags TEXT NULL, MODIFY aid INT(11) NULL, MODIFY date DATE NULL, MODIFY amount DECIMAL(18,2) NULL');



    

// ORM::execute('ALTER TABLE `sys_items` ADD `sold_count` DECIMAL(16,4) NULL DEFAULT \'0.0000\', ADD `total_amount` DECIMAL(16,4) NULL DEFAULT \'0.0000\', ADD `created_at` TIMESTAMP NULL, ADD `updated_at` TIMESTAMP NULL');

 }

if($config['build'] <= 4670){

    ORM::execute('ALTER TABLE `crm_groups` ADD `created_at` TIMESTAMP  NULL  DEFAULT NULL, ADD `updated_at` TIMESTAMP  NULL  DEFAULT NULL');
    ORM::execute('ALTER TABLE `sys_users` ADD `created_at` TIMESTAMP  NULL  DEFAULT NULL, ADD `updated_at` TIMESTAMP  NULL  DEFAULT NULL');
    ORM::execute('ALTER TABLE `sys_accounts` ADD `created_at` TIMESTAMP  NULL  DEFAULT NULL, ADD `updated_at` TIMESTAMP  NULL  DEFAULT NULL');
